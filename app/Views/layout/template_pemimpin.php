...
<head>
    ...
    <style>
        ...
        .table-hover tbody tr:hover {
            ...
            /* Sedikit efek zoom/angkat agar interaktif */
            ...
            <div class="sidebar">
                <nav class="mt-4">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-header text-white-50">IKHTISAR EKSEKUTIF</li>
                        ...
                        <li class="nav-header text-white-50">LAPORAN KEUANGAN</li>
                        ...
                        <li class="nav-item">
                            <a href="/laporan/neraca-saldo" class="nav-link <?= (isset($active_menu) && $active_menu == 'laporan-neraca-saldo') ? 'active' : '' ?>">
                                <i class="fas fa-balance-scale-right nav-icon"></i>
                                <p>Neraca Saldo</p>
                            </a>
                        </li>

                        <li class="nav-header text-white-50" style="margin-top: 20px; border-top: 1px solid #d32f2f;">ADMINISTRASI DATA</li>

                        <li class="nav-item">
                            <a href="/dapur/jurnal" class="nav-link text-warning"> <i class="fas fa-edit nav-icon"></i>
